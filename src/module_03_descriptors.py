...
Computes RDKit constitutional/physicochemical descriptors and topological fingerprints,
aggregating compound values to macroscopic extract profile states.
"""
