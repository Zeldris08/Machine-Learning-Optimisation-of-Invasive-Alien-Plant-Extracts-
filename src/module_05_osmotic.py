...
Calculates an osmotic inhibition matrix using van 't Hoff osmotic potential models
to account for non-allelopathic osmotic stresses within higher concentration bands.
"""
