...
Trains Random Forest and XGBoost regressors for each of three endpoints.
Performs stratified train/test split, 5-fold cross-validation, and
generates comparison metrics. Saves fitted scalers.

Usage:
    python src/module_06_training.py [--debug]
"""
